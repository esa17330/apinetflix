  ...
  <tbody>
    <tr>
      ...
      <td><select id="serie" name="serie">
				...
				<c:forEach var="serie" items="${saison}">
	  ...
	  <td><select id="serie" name="serie">
				<option value="0">Choisissez un épisode</option>
				<c:forEach var="serie" items="${episode}">
					<option value="${episode.id}">
						<c:out value="${episode.nom}"/>
					</option>
				</c:forEach>
			</select> </td>
      <td><a href='<c:url value="/serie/${id}"/>'><img src="images/lire.JPG" alt="lire" id="lire" class="img-size"></a></td>
      <td><a href='<c:url value="/serie/${id}"/>'><img src="images/trash.jpg" alt="supprimer" id="supprimer" class="img-size"></a></td>
       <td><a href='<c:url value="/saison/${id}"/>'><img src="images/link.jpg" alt="link" id="link1" class="img-size"></a></td>
    </tr>
  </tbody>
</table>
      </form>
