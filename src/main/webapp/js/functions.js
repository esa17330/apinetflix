...
function go_liremodifSaison(optionvalue) {
	location.href="/apiMynetflix/LireModifSaison?saison="+optionvalue+
	"&idserie="+sessionStorage.getItem("idserie");
}
...
function go_supprimerSaison(optionvalue) {
	location.href="/apiMynetflix/Saison?supprimer="+optionvalue;
