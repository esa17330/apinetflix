...
public class Serie {
	...
	public Serie(String nom, String nomOriginal, int anneeParution, String synopsis, int idstatut, int idPaysOrigine) {
		super();
		this.nom = nom;
	...
	public Serie(int id, String nom, String nomOriginal, int anneeParution, String synopsis, int idstatut,
